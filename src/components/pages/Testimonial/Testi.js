...
const Test = [
  {
    img: "https://img.freepik.com/premium-vector/customer-feedback-client-testimonials-social-media-post-web-banner-template_600409-163.jpg?w=2000",
  },
  {
  ...
  {
    img: "https://img.freepik.com/premium-psd/customer-feedback-testimonial-social-media-post-web-banner-template_169307-1854.jpg?w=2000",
  },
];
                ...
                <div className="card-container">
                  <div className="card">
                    <div className="card-body">
                      <img src={i.img} className="BannerImg" alt="" />
                      <div
                        style={{
                          marginTop: "10px",
                        }}
