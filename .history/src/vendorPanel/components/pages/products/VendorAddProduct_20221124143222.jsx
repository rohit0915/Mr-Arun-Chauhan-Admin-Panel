...
const VendorAddProduct = () => {
  ...
  return (
    <>
      <div className="flex sticky top-0 py-3 px-5 bg-slate-100 justify-between rounded-full text-[rgb(240,72,88)]">
        <span className=" font-semibold rounded-full text-[rgb(240,72,88)] ">
          Add Products
        </span>
      </div>
      {/* form */}
