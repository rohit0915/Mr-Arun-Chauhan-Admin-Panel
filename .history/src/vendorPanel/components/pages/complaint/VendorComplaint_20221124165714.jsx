...
const pay = [
  ...
  },
  {
    ...
    status: "Pending",
    Amount: 5000,
    Message : 'Error! Error!Error!Error! Error!Error! Error! Error!Error! Error! Error!Error!Error! '
  },
];


const VendorComplaint = () => {
  return (
    <>
      <section>
            ...
            <tbody>
              {pay.map((i, index) => (
                <tr key={index} className="tracking-wider text-gray-900 ">
                  ...
                  <td className="px-4 py-3 md:text-base text-sm">{i.Message }</td>
...
export default HOC(VendorComplaint);
