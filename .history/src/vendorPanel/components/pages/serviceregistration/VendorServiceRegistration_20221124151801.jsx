...
const VendorServiceRegistration = () => {
  ...
  const addBanner = async (e) => {
    ...
    fd.append("banneremail", email);
    fd.append("bannerpassword", password);
      ...
      <section>
        <div className="pb-4 sticky top-0  w-full flex justify-between items-center bg-white">
          <span className="tracking-widest text-slate-900 font-semibold uppercase ">
            All Venror Service Registration
          </span>
          <button
            onClick={() => {
              setEdit("");
          ...
          >
            Add Venror Service Registration
          </button>
        </div>
        {/* Add Form */}
        <section
          ...
          <div className="bg-slate-100 sm:h-[90vh] h-[80vh] overflow-y-auto  lg:w-3/6  md:w-4/6 w-5/6 mx-auto  rounded-lg">
            <div className="flex sticky top-0 py-3 px-5 bg-slate-100 justify-between">
              <span className=" font-semibold text-[rgb(241,146,46)] ">
                Update Venror Service Registration
              </span>
