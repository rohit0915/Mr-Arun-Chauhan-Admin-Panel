...
import Notify from "./components/pages/Notify/Notify";
import Payment from "./components/pages/Payment/Payment";
import SubCat from "./components/pages/SubCategory/SubCat";
import Testi from "./components/pages/Testimonial/Testi";
import Complaint from "./components/pages/Complaint/Complaint";
import VendorNotify from "./vendorPanel/components/pages/VendorNotify/VendorNotify";
    ...
    <>
      ...
      <Routes>
        ...
        <Route path='/detail' element={<Payment />} />
          ...
          <Route path='/testimon' element={<Testi />} />
        ...
        />
      <Route path='/vendorNotify' element={<VendorNotify />} />
