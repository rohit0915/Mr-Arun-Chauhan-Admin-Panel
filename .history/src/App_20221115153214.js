  ...
  return (
    <>
      ...
      <Route path="/brand" element={}
        ...
        <Route path="/accept-request-from-vendors" element={<AcceptRequestFromVendors />} />
        ...
        <Route path="/vendorService-registration" element={<VendorServiceRegistration />} />
        ...
        <Route path="/vendorTask-performed" element={<VendorTaskPerformedDetails />} />
        ...
        <Route path="/vendorManages" element={<VendorManagesProductsServices />} />
        <Route path="/vendorManage-partner" element={<VendorManagePartnerMerchant />} />
        <Route path="/vendorPayment" element={<VendorPayment />} />
        <Route path="/vendorAdd-to-cart" element={<VendorAddToCart />} />
        <Route path="/vendorPaid-ads-feature" element={<VendorPaidAdsFeature />} />
        <Route path="/vendorUsers-comment" element={<VendorUsersComment />} />
        <Route path="/vendorRating-and-reviews" element={<VendorRatingAndReviews />} />
        ...
        <Route path="/vendorTransactions" element={<VendorCheckOutTransactions/>} />
       <Route path="/vendorCategory-details" element={<VendorCategoryDetails/>} /> 
      </Routes>
    </>
  );
}
