            ...
            <tbody>
              {products?.data?.map((i, index) => (
                <tr key={i} className="tracking-wider text-gray-900 ">
                  ...
                  <td className="px-4 py-3 md:text-base text-sm">{i.brand=== null ? 'Brand' : i.brand}</td>
                  <td className="px-4 py-3 md:text-base text-sm "  style={{display : 'flex'  , gap : '10px'}}   >
                  <Button variant="outlined" color="error">Dete</Button>
