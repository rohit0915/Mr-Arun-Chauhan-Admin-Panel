          ...
          <table className="table-auto  w-full text-left whitespace-no-wrap">
            <thead>
              <tr className=" border-b bg-slate-200 shadow-xl text-gray-900">
                ...
                <th className="px-4 py-3 title-font tracking-widest rounded-tr-lg font-medium md:text-base text-sm  ">
                  Similar Products Type displayed at bottom
                </th>
                <th className="px-4 py-3 title-font tracking-widest rounded-tr-lg font-medium md:text-base text-sm  ">
            ...
            {products?.data?.map((i , index) => (
              ...
              <Carousel autoPlay infiniteLoop width="20%" showThumbs={false}>
    <div>
      <img
        alt=""
        src="https://static7.depositphotos.com/1003098/699/i/600/depositphotos_6993693-stock-photo-happy-young-girl-using-cell.jpg"
      />
    </div>
    <div>
      <img
