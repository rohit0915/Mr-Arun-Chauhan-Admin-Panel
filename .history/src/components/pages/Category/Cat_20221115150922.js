  ...
  const deleteBanner = async (id) => {
    try {
      const data = await axios.delete(
        ` https://pitzone-backend.herokuapp.com/api/category/630dea92791656f65f768343`
      );
        ...
        >
          <Box sx={style}>
            ...
            <form className="mt-14" onSubmit={addBanner}>
              ...
              <Button variant="outlined" color="success" type="submit" style={{width : '80%' , fontSize : '1.2rem'}}>
                Success
              </Button>
            </form>
          </Box>
